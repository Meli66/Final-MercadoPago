...
public class principal2 {
	...
	public static void main(String[] args) {
		...
		String opciones = JOptionPane
				.showInputDialog("Bienvenido Mercado Pago! Para registrarse ingrese 1" + "\n Para logearse ingrese 2"
		...
		while (!opciones.equalsIgnoreCase("8")) {
			...
			if (opciones.equalsIgnoreCase("1")) {
				...
				usuarioService.registrar(new Usuario(email, password, saldo));
				...
				boolean esValido = usuarioService.validar(email, password);
				...
				usuarioService.editar(email, password);
				...
				String tipo = JOptionPane.showInputDialog("Ingrese el tipo de factura que desea abonar(Ej: Luz, Gas)");
				String empresa = JOptionPane.showInputDialog(
						"Ingrese el nombre de la empresa prestadora del servicio(Ej: Edesur, Edenor, MetroGAS)");

				Factura factura = new Factura(tipo, empresa);
				Usuario usuario = usuarioService.buscar(email);

				System.out.println(facturaService.pagar(factura, usuario));

			} else if (opciones.equalsIgnoreCase("6")) {

				String numero = JOptionPane.showInputDialog("Ingrese su numero de celular");
				String empresa = JOptionPane.showInputDialog("Ingrese la empresa de su celular(Ej: Movistar, Claro)");
				...
				String red = JOptionPane
						.showInputDialog("Ingrese la red del transporte(Ej: SUBE, REDBUSCOR, CIUDADANA");
			...
			opciones = JOptionPane.showInputDialog(
					"Bienvenido Mercado Pago! Para registrarse ingrese 1" + "\n Para logearse ingrese 2"
							+ "\n Para editar un usuario ingrese 3" + "\n Para eliminar un usuario ingrese 4"
							+ "\n Para pagar una factura ingrese 5" + "\n Para realizar una recarga celular ingrese 6"
							+ "\n Para cargar pase de transporte ingrese 7" + "\n Para salir ingrese 8");
